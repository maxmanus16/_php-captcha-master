...
function simple_php_captcha($config = array()) {
    ...
    $captcha_config = array(
        ...
        'fonts' => array(
            $font_path . 'PoetsenOne-Regular.ttf'
        ),
    ...
    // Kullanıcı tarafından ayarlanmazsa, CAPTCHA kodu üretir
